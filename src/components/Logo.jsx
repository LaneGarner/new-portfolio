...
const Logo = ({ width, height }) => {
  return (
    // <svg xmlns="http://www.w3.org/2000/svg" width="489.346" height="368.551" viewBox="0 0 489.346 368.551">
    <svg
    ...
    >
      <g
        id="Group_8"
        data-name="Group 8"
        transform="translate(-138.776 -131.193)"
      >
        <g
          id="Group_4"
          data-name="Group 4"
        ...
        <g
          id="Group_7"
          data-name="Group 7"
          transform="translate(162.327 223.691)"
        >
          <path
            id="Path_13-2"
            data-name="Path 13"
            d="M407.17,11.764l-85.68,53.1L170.54-16.213,124.114,26.519,0,1.091"
            transform="translate(0 101.654)"
            fill="none"
            stroke="#707070"
            strokeWidth="4"
          />
